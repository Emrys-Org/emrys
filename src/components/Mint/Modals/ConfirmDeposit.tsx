  ...
  return (
    ...
    >
      ...
      <div className="z-10 flex w-full flex-col gap-y-24 pt-24 sm:pt-0">
        ...
        {/* Asset */}
        <DepositAssetBanner assetFrom={assetFrom} assetTo={assetTo} cryptoType={cryptoType} />
...
const DepositAssetBanner = ({
  ...
  return (
    <div className={styles.confirmDeposit__banner}>
      <div className={styles.confirmDeposit__banner__item}>
        <div className={styles.confirmDeposit__banner__item__icon}>
          <Icon name={assetFrom.name.toLowerCase() as IconName} />
        </div>
        <div className={styles.confirmDeposit__banner__item__info}>
          <span className={styles.confirmDeposit__banner__item__info__amount}>
            {assetFrom.amount}
          </span>
          <span className={styles.confirmDeposit__banner__item__info__name}>
            {assetFrom.name}
          </span>
          {assetFrom.isLocked && (
            <div
              className={styles.confirmDeposit__banner__item__info__lock__icon}
            >
              <Icon name="Lock" />
            </div>
          )}
      ...
      <div className={styles.confirmDeposit__banner__arrow}>
